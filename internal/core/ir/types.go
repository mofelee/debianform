...
const (
	...
	DockerOfficialUbuntuRepositoryURL = "https://download.docker.com/linux/ubuntu"
	DockerOfficialUbuntuGPGURL        = "https://download.docker.com/linux/ubuntu/gpg"
