...
assert_remote "restore-mode apt cache refresh fetched Aliyun trixie metadata" \
  "find /var/lib/apt/lists -maxdepth 1 -type f -name '*mirrors.aliyun.com_debian_dists_trixie_InRelease' | grep -q ."
