...
- 此提交的受管目标 CI 证据：
  - Ubuntu 24.04 LTS amd64 libvirt 矩阵（25/25）：<通过 | 失败；CI 运行 URL>
  - Ubuntu 26.04 LTS amd64 libvirt 矩阵（25/25）：<通过 | 失败；CI 运行 URL>
  - Debian 12 amd64 libvirt 矩阵（25/25）：<通过 | 失败；CI 运行 URL>
  - Debian 13 amd64 libvirt 矩阵（25/25）：<通过 | 失败；CI 运行 URL>
...
- Ubuntu 24.04、Ubuntu 26.04、Debian 12 和 Debian 13 的受管目标证据分别以 `25/25`
