...
- Managed-target CI evidence for this commit:
  - Ubuntu 24.04 LTS amd64 libvirt matrix (25/25): <pass | fail; CI run URL>
  - Ubuntu 26.04 LTS amd64 libvirt matrix (25/25): <pass | fail; CI run URL>
  - Debian 12 amd64 libvirt matrix (25/25): <pass | fail; CI run URL>
  - Debian 13 amd64 libvirt matrix (25/25): <pass | fail; CI run URL>
...
- Ubuntu 24.04, Ubuntu 26.04, Debian 12, and Debian 13 managed-target evidence
  is listed separately as `25/25`, points to the release commit's CI run, and
