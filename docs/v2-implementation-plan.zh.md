...
- [ ] v2 编译器尚未完整实现；Loop 3 已支持 HostSpec、ResourceGraph 和 create-only plan
- [ ] v2 CLI 尚未完整接入；Loop 3 已支持 `validate` 和 `plan`
- [ ] v2 plan 已有 create-only 预览；apply 尚未实现
