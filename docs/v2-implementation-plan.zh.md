...
- [x] 新增 `examples/v2-component-inputs.dbf.hcl`
- [x] 示例 component 使用 `list(object(...))` 生成 JSON 配置文件
- [x] 示例覆盖 optional 字段默认值补齐
- [x] 示例进入 runnable v2 examples validate 测试

文档：

- [x] README 增加 component input 2.0 简短示例
- [x] `docs/v2-component-input-requirements.zh.md` 标记本轮已实现范围
- [x] `docs/v2-requirements.md` 更新 component input 支持类型列表
- [x] `docs/v2-ir-requirements.zh.md` 更新 ComponentInputSpec

验收：

- [x] `dbf validate -f examples/v2-component-inputs.dbf.hcl` 成功
- [x] `dbf plan -f examples/v2-component-inputs.dbf.hcl --offline --format json` 成功
