...
- [x] 更新 `examples/v2-component-inputs.dbf.hcl`，增加端口范围 validation
- [x] 增加 invalid fixture 覆盖 validation failure

文档：

- [x] README 示例展示一个短 validation
- [x] `docs/v2-component-input-requirements.zh.md` 标记 validation 已实现函数集合
...
- [x] 更新 `examples/v2-component-inputs.dbf.hcl`，增加 sensitive `environment` input
- [x] 示例 plan golden 确认 secret value 不泄漏

文档：

- [x] README 补充 sensitive input 行为说明
- [x] `docs/v2-state.md` 补充 sensitive input 派生内容不落盘规则
- [x] `docs/v2-plan-format.md` 补充 sensitive summary/redaction 字段
- [x] `docs/v2-component-input-requirements.zh.md` 标记 sensitive propagation 已实现范围

验收：

- [x] `dbf plan -f examples/v2-component-inputs.dbf.hcl --offline --format json` 不包含 sensitive 明文
...
- [x] `examples/v2-component-inputs.dbf.hcl` 进入 README 示例列表
...
- [x] `docs/v2-component-input-requirements.zh.md` 更新实现状态
- [x] `docs/v2-implementation-plan.zh.md` 勾选完成项
