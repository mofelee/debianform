...
- [x] Docker / Docker Compose 需求文档已保存：`docs/docker-compose-requirements.zh.md`
- [x] 已有 parser、merge、HostSpec、ResourceGraph、plan、apply、check 主流程
- [x] 已有 APT repository、APT signing key、package、file、directory、group、systemd unit、service 和 operation provider
- [x] 已有 runtime facts discovery，可在线探测 `system.architecture` 和 `system.codename`
- [x] 已有 fake runner / memory provider 测试基础
...
- [x] HostSpec golden 覆盖 `docker-minimal`
- [x] HostSpec golden 覆盖 `docker-daemon`
- [x] HostSpec golden 覆盖 `docker-compose`
- [x] 负例覆盖非法 enum、重复 compose label、缺失 directory、非法 file content/source 组合

示例：

- [x] 新增 `examples/docker-minimal.dbf.hcl`
- [x] 新增 `examples/docker-daemon.dbf.hcl`
- [x] 新增 `examples/docker-compose.dbf.hcl`
...
- [x] `examples/docker-minimal.dbf.hcl` 进入 graph / plan golden
...
- [x] `examples/docker-minimal.dbf.hcl` 进入 fake runner apply 测试
...
- [x] `examples/docker-daemon.dbf.hcl` 进入 golden
...
- [x] `examples/docker-compose.dbf.hcl` 进入 graph / plan golden
...
- [x] `pull = never|missing|always` 映射为 Docker Compose 支持的命令行为
- [x] `recreate = auto|always|never` 映射为 Docker Compose 支持的命令行为
...
- [x] `examples/docker-compose.dbf.hcl` 进入 fake runner apply 测试
...
- [x] `examples/docker-compose.dbf.hcl` 增加 systemd 默认行为注释
...
- [x] 新增 `examples/docker-users.dbf.hcl`
...
- [x] 新增 `examples/docker-package-sources.dbf.hcl`
