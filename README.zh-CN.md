...
amd64 也进入 Beta 支持；Ubuntu 24.04 LTS amd64 为 Preview。建议先在低风险测试主机上试用。
...
更完整的 Debian 新手教程见 [Quickstart](docs/quickstart.zh.md)；Ubuntu 24.04 LTS amd64
请从 [Ubuntu Preview Quickstart](docs/ubuntu-24.04-quickstart.zh.md) 开始。后续章节见
...
- Debian 12 amd64 为 Beta，和 Debian 13 amd64 一起进入阻断式 libvirt CI；Debian 12 arm64
  仍为 Preview。
- Ubuntu 24.04 LTS amd64 为 Preview，并有独立的 20-case 阻断矩阵；其他 Ubuntu 版本、
  Ubuntu arm64 和桌面环境为 Unsupported。
...
- [Ubuntu Preview Quickstart](docs/ubuntu-24.04-quickstart.zh.md)：Ubuntu 24.04 LTS amd64 的安全首跑路径。
